...
const argv = require('yargs')
    ...
    .option('privateKey', {
        alias: 'p',
        default: '797c13f7235c627f6bd013dc17fff4c12213ab49abcf091f77c83f16db10e90b', // This is the private key of the admin
...
async function main() {
    ...
    try {
        switch (argv._[0]) {
            // When doing the DELEGATED demo we have to use the address of the central authority contract to grant/revoke/check roles
            case "hasRole":
                contract = await new web3.eth.Contract( accessControlContractJson, process.env.CONTRACT_CENTRAL_AUTHORITY);
